            ...
            <div class="card border-dark">
                <div class="card">
                    ...
                    ?>
                        ...
                        <label for="">Hasil-Hasil Konsultasi :</label>
                        <table class="table table-bordered">
                        <thead>
                        <tr>
                            <th width="40px">No.</th>
                        ...
                        $sql = "SELECT detail_penyakit.idkonsultasi,detail_penyakit.idpenyakit,penyakit.nmpenyakit,penyakit.solusi,detail_penyakit.persentase
                                ...
                                ON detail_penyakit.idpenyakit=penyakit.idpenyakit WHERE idkonsultasi='$idkonsultasi' ORDER BY persentase DESC";
                        $result = $conn->query($sql);
                        while($row = $result->fetch_assoc()) {
                    ?>
                        <tr>
